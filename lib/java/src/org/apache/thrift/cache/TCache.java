...
public interface TCache {
	...
	/**
	 * reading from the cache based on tcache key, else get the cache entry through getResut callback and write it to the cache
	 * 
	 * @param key
	 * @return
	 * @throws TException
	...
	/**
	 * Deleting from the cache based on tcache key and if the deletion should be
	 * done f tcache key is partial.
	 * 
	 * @param key
	 * @param partial
	 * @throws TException
	...
	/**
	 * Handles any miscellaneous operation other than the other specified cache
	 * operations
	 * 
	 * @param tCacheKey
